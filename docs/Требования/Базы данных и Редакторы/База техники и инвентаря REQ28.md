...
На странице отображены три таблицы: "Тип", "Подтип", "Наименование".\
...
---
## Описание таблиц
Таблицы "Типа", "Подтипу", "Наименование" выполнены в один столбец и предоставляют перечень типов сущности соответствующей таблицы.\
