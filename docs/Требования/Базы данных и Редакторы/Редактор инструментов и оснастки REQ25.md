...
Страница "Редактор инструмента и оснастки" предоставляет пользователю возможность управлять всеми аспектами информации о создаваемой или редактируемой сущности.\
Пользователь может:
