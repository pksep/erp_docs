...
- **Отображение информации**
  - Таблица показывает информацию о деталях, предназначенных для операции листовой резки.
...
---
## Макет 
![Пример изображение страницы Листовой резки](\img\SheetCutting.png)
![Пример изображение страницы Листовой резки](\img\SheetCutting2.png)
...
---
## Описание таблицы "Листовая резка" (Table 1)
...
- **Кол-во шт.**
  - Количество деталей, заказанных для склада, которые требуются по заказам.
- **Срок отгрузки**
