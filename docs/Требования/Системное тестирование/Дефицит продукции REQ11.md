...
Страничка предназначена для управления дефицитом продукции на складе.\
...
Фильтр "Дефициты" реализован в форме выпадающего меню и предназначен для управления данными о дефиците продукции.\
...
## Описание Таблицы Дефицита Продукции (Table 1)
