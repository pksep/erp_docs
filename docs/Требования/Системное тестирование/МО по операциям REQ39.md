...
## Путь
Производство (/production) -> Металлообработка (/metalloworking) -> Детали по операциям -> Операция: *:ИмяОперации*
...
- **Отображение информации**
  - Таблица показывает информацию о деталях, предназначенных для операции *:ИмяОперации*.
...
---
## Макет 
![Пример изображение страницы Операция: *:ИмяОперации*](\img\MetalworkingOperation.png)
![Пример изображение страницы Операция: *:ИмяОперации*](\img\MetalworkingOperation2.png)
